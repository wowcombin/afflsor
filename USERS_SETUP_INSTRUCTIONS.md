...
| yupiter871@gmail.com | 8f947e16-d0a8-4272-878e-c484d347365c-hr | HR | Юрий |
...
**Решения:**
1. **Один аккаунт - одна роль**: Выберите CFO или HR
2. **Два отдельных аккаунта**: Используйте разные email (например, `yupiter871+hr@gmail.com`)
3. **Система множественных ролей**: Модифицируйте auth_id для HR роли
