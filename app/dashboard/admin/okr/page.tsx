...
export default function AdminOKRPage() {
    ...
    const columns: Column<StrategicGoal>[] = [
            ...
            render: (goal) => (
                <div className="w-full">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                            className={`h-2 rounded-full ${goal.achievement_status === 'achieved' ? 'bg-green-600' :
        ...
        },
        {
            ...
            label: 'Статус',
            render: (goal) => (
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${goal.achievement_status === 'achieved'
