  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Управление личными данными и настройками аккаунта менеджера</p>
      </div>
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <h4 className="font-medium text-green-900 mb-2">👨‍💼 Для менеджеров:</h4>
        <div className="text-sm text-green-800 space-y-1">
          <div>• Ваш Telegram будет отображаться в системе выводов</div>
          <div>• Junior сотрудники будут видеть ваше имя при работе с выводами</div>
          <div>• Настройки влияют на отображение в отчетах и уведомлениях</div>
          <div>• Убедитесь, что данные актуальны для корректной работы команды</div>
        </div>
      </div>
    </div>
  )
