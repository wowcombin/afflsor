  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Настройки Team Lead</h1>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-orange-700">
              <p>• Вы руководите командой Junior сотрудников</p>
              <p>• Отвечаете за выводы и карты своей команды</p>
              <p>• Назначение Junior'ов осуществляется через HR</p>
              <p>• Получаете процент от профита команды</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="card-body">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <span className="inline-block px-3 py-1 rounded-full text-sm font-medium text-orange-600 bg-orange-50">
                Team Lead
              </span>
              <p className="text-xs text-gray-500 mt-1">Руководитель команды</p>
            </div>
            <div>
        ...
        <div className="card-body space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">Для связи с командой и уведомлений</p>
            </div>
            <div>
              ...
              <p className="text-xs text-gray-500">Для получения процента от профита команды</p>
            </div>
          </div>
      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="text-sm font-medium text-gray-700">Процент от профита команды</label>
              <p className="text-2xl font-bold text-primary-600">{currentUser.salary_percentage}%</p>
              <p className="text-xs text-gray-500">От общего профита вашей команды</p>
            </div>
            <div>
          ...
          <div className="mt-4 p-3 bg-orange-50 rounded-lg">
            <p className="text-sm text-orange-700">
              💰 <strong>Как рассчитывается зарплата Team Lead:</strong> Вы получаете процент от общего профита 
              вашей команды Junior'ов + фиксированный ежемесячный бонус. Для изменения параметров обратитесь к HR.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="card-body">
          ...
          <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h4 className="text-sm font-medium text-yellow-800">Рекомендации по безопасности для Team Lead</h4>
                <ul className="mt-2 text-sm text-yellow-700 space-y-1">
                  <li>• Используйте сложный пароль для защиты данных команды</li>
                  <li>• Не передавайте данные карт третьим лицам</li>
                  <li>• Регулярно проверяйте активность своих Junior'ов</li>
                  <li>• Обеспечьте безопасность процессов команды</li>
                </ul>
              </div>
            </div>
          </div>
