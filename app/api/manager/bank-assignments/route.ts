...
export async function POST(request: Request) {
    ...
    // Проверяем, не назначен ли банк уже этому же Team Lead'у
    ...
    if (existingAssignment) {
      return NextResponse.json({ 
        error: 'Банк уже назначен этому Team Lead\'у',
        details: 'Данный Team Lead уже имеет доступ к этому банку'
      }, { status: 400 })
    }
